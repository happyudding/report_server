...
def test_rawdata_basis_default():
    ...
    assert payload["yield_basis"] == {"basis": "test", "gross_die": None}, payload["yield_basis"]
...
def test_gross_die_basis():
    ...
    assert payload["yield_basis"] == {"basis": "gross", "gross_die": 20}, payload["yield_basis"]
...
def test_gross_die_text_forms():
    ...
    for value, expected in (("20", 20), ("20.0", 20), (20, 20), ("1,200", 1200)):
        payload = build_report_payload([make_table()], gross_die=value)
