...
# VOC(고객의 소리) 접수 페이지 URL — 도움말 메뉴 'VOC' 클릭 시 기본 브라우저로 열림.
# 실제 접수 URL 은 추후 확정 (배포 시 HONEY_VOC_URL 환경변수로 교체 가능).
VOC_URL = os.environ.get("HONEY_VOC_URL", "https://example.com/voc")
