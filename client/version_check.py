...
3) download_to(target, url, expected_sha256) 로 다운로드
4) updater.bat 동적 생성 + 실행 + 자기 종료

스켈레톤 단계에서는 다운로드까지만 검증.
"""
import hashlib
...
def download_to(target_path, url, expected_sha256=None, base_url=None):
